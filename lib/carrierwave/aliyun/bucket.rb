  ...
  module Aliyun
    class Bucket
      ...
      def oss_client
        ...
        @oss_client = ::Aliyun::OssDup::Client.new(@aliyun_access_id, @aliyun_access_key, opts)
      end
      ...
      def img_client
        ...
        @img_client = ::Aliyun::OssDup::Client.new(@aliyun_access_id, @aliyun_access_key, opts)
      end
      ...
      def oss_upload_client
        ...
        @oss_upload_client = ::Aliyun::OssDup::Client.new(@aliyun_access_id, @aliyun_access_key, opts)
      end
    end
  end
end
